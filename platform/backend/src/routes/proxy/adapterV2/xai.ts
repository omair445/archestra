...
function convertMcpImageBlocksToCerebras(
  ...
  const cerebrasContent: XaiToolResultContentBlock[] = [];
  ...
  for (const item of content) {
    ...
    if (isMcpImageBlock(item)) {
      ...
      logger.info(
        ...
        "[XaiAdapter] Converting MCP image block to Cerebras format",
      );
  ...
  logger.info(
    ...
    "[XaiAdapter] Converted MCP content to Cerebras format",
  );
