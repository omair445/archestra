 ...
 *
 * x.ai provides OpenAI-compatible inference at https://api.x.ai/v1
 * Models include grok-4, grok-4-1-fast-reasoning, grok-4-1-fast-non-reasoning, grok-code-fast-1
 *
